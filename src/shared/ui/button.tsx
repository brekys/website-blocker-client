                ...
                clsx(
                    {
                        ...
                        'outlined': 'border border-slate-300 hover:border-slate-500 hover:text-white disabled:opacity-50',
                    }[variant],
                    className, 'px-4 h-10 rounded cursor-pointer flex gap-2 items-center justify-center',
                )
            }
        />
    )
